...
- ID: 5, Name: New checking account
    1. User starts bank application in the terminal -- seeing the landing page screen
    2. User enters appropriate key to login to the bank
    3. User enters appropriate key to create a new checking account
    4. Bank application fails to create a new checking account for user

- ID: 6, Name: Checking account details
    1. User starts bank application in the terminal -- seeing the landing page screen
    2. User enters appropriate key to login to the bank
    3. User enters appropriate key to view checking accounts
    4. User enters appropriate key to view first checking account details
    5. Bank application fails to show details of checking account
...
- ID: 7, Name: Closing checking account
    ...
    3. User enters appropriate key to view checking accounts
    4. User enters appropriate key to view first checking account details
    5. User enters appropriate key to close checking account
    6. User is not prompted to confirm close of checking account
    7. Bank application fails to close checking account

## Negative Use Case Scenario Data

- ID: 1, Name: User registration
   - invalid username = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" (too long)
   - valid password = "jon"
- ID: 1, Name: User registration
  - valid username = "jon"
  - invalid password = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" (too long)
- ID: 1, Name: User registration
  - non-unique username = "jon" (jon already registered)
  - valid password = "jon"

- ID: 2, Name: User login
  - invalid username = "jon" (jon not registered)
  - valid password = "jon"
- ID: 2, Name: User login
  - valid username = "jon" (jon already registered)
  - invalid password = "j" (not jon's password)

- ID: 3, Name: Deposit of funds
  - valid username = "jon" (account is already registered)
  - valid password = "jon"
  - key presses = "1 + ENTER" (to view checking accounts)
  - key presses = "1 + ENTER" (to view first checking account details)
  - key presses = "1 + ENTER" (to start deposit process)
...
| ID | Description | Preconditions | Test Data | Steps | Expected Outcome | Actual Outcome | Who executed the test | Status |
|----|-------------|---------------|-----------|-------|------------------|----------------|-----------|----------------------|
| 1  | User registration | User is not logged in | valid username = "jon", valid password = "<PASSWORD>" | User enters appropriate key to register with the bank | User is prompted to enter a username, and enters a non-unique username | User is prompted to enter a username, and enters a non-unique username | Jon | Pass |
| 2  | User registration | User is not logged in | valid username = "jon", valid password = "<PASSWORD>" | User enters appropriate key to register with the bank | User is prompted to enter a username, and enters a username that is too long | User is prompted to enter a username, and enters a username that is too long | Jon | Pass |
| 3  | User registration | User is not logged in | valid username = "jon", valid password = "<PASSWORD>" | User enters appropriate key to register with the bank | User is prompted to enter a password, and enters a password that is too long | User is prompted to enter a password, and enters a password that is too long | Jon | Pass |
| 4  | User login | User is not logged in | valid username = "jon", valid password = "<PASSWORD>" | User enters appropriate key to login to the bank | User is prompted to enter a username, and enters a username that does not exist | User is prompted to enter a username, and enters a username that does not exist | Jon | Pass |
| 5  | User login | User is not logged in | valid username = "jon", valid password = "<PASSWORD>" | User enters appropriate key to login to the bank | User is prompted to enter a password, and enters the wrong password | User is prompted to enter a password, and enters the wrong password | Jon | Pass |
| 6  | Deposit of funds | User is logged in | valid username = "jon", valid password = "<PASSWORD>" | User enters appropriate key to login to the bank | User enters appropriate key to view checking accounts | User enters appropriate key to view checking accounts | Jon | Pass |
| 7  | Deposit of funds | User is logged in | valid username = "jon", valid password = "<PASSWORD>" | User enters appropriate key to login to the bank | User enters appropriate key to view first checking account details | User enters appropriate key to view first checking account details | Jon | Pass |
